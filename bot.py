...
async def search_stock(update: Update, context: CallbackContext): text = update.message.text.lower() matches = [name for name in mock_stock_data if text in name.lower()]
